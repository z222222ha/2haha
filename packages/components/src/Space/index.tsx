...
export default function Space(props: SpaceProps) {
  ...
  // 处理样式
  const cns = cs(className, Styles["space"], {
    [Styles["space-horizontal"]]: direction === "horizontal",
    [Styles["space-vertical"]]: direction === "vertical",
    [Styles["space-wrap"]]: wrap,
    [Styles["space-align-start"]]: align === "start",
    [Styles["space-align-center"]]: align === "center",
    [Styles["space-align-end"]]: align === "end",
    [Styles["space-align-baseline"]]: align === "baseline",
  });
  // todo：使用 usememo？
